...
countWordToCount:
    mov ebx, BUFFER_P2      ;pointer of current check of word
    mov ecx, BUFFER_P2      ;pointer of the current letter
    mov edx, WORD_TO_COUNT
    jmp .checkWord


.nextChar:
    inc ebx
    mov ecx, ebx      ;pointer of the current letter
    mov edx, WORD_TO_COUNT
